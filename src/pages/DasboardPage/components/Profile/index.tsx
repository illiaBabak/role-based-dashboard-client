...
export const Profile = ({ user, isCurrentUser }: ProfileProps) => {
  ...
  return (
    ...
    >
      ...
      >
        {isCurrentUser && (
          <span data-testid="profile-you-badge" className="absolute right-4 top-4 rounded-full bg-emerald-500/20 px-2 py-0.5 text-[10px] font-medium text-emerald-400">
            You
          </span>
        )}
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            <h2 data-testid="profile-name" className="text-base font-bold text-white">{user.name}</h2>
            <span data-testid="profile-role" className="inline-block rounded-full bg-indigo-500/15 px-2 py-px text-[11px] font-medium capitalize text-indigo-400">
              {user.role}
            </span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div>
            ...
            <p data-testid="profile-login" className="rounded-lg border border-white/5 bg-white/[0.02] px-3 py-2 text-sm text-white">
              {user.login}
            </p>
          </div>
            ...
            {showDeleteConfirm ? (
              ...
              >
                <div className="rounded-lg border border-red-500/20 bg-red-500/5 p-3">
                  ...
                  <div className="flex gap-2.5">
                    <button
                      data-testid="profile-confirm-delete"
                    ...
                    <button
                      data-testid="profile-cancel-delete"
